...
public class UserFactory {
    ...
    public static List<Doctor> getDefaultDoctors() {
        ...
        doctors.add(new Doctor("John", "Doe", "johndoe@clinicdoc.com", "pass1", "Male", LocalDate.of(1999, 3, 12),
                Specialization.CARDIOLOGY, "LIC12345"));
        doctors.add(new Doctor("Jane", "Smith", "janesmith@clinicdoc.com", "pass2", "Female", LocalDate.of(2001, 7, 4),
                Specialization.NEUROLOGY, "LIC67890"));
        doctors.add(new Doctor("Emily", "Johnson", "emilyjohnson@clinicdoc.com", "pass3", "Female",
                LocalDate.of(2003, 3, 6), Specialization.PEDIATRICS, "LIC54321"));
        return doctors;
    }
    ...
    public static List<Patient> getDefaultPatients() {
        ...
        patients.add(new Patient("Alice", "Brown", "alicebrown@gmail.com", "pass4", "Female", LocalDate.of(2000, 1, 1),
                "123456789", "2045551234"));
        patients.add(new Patient("Bob", "Davis", "bobdavis@gmail.com", "pass5", "Male", LocalDate.of(1999, 3, 12),
                "987654321", "4315555678"));
        patients.add(new Patient("Charlie", "Wilson", "charliewilson@gmail.com", "pass6", "Male",
                LocalDate.of(2001, 7, 4), "789012123", "4315559012"));
        return patients;
    }
    ...
    public static List<Staff> getDefaultStaffs() {
        ...
        staffs.add(new Staff("Eve", "Miller", "evemiller@clinicstaff.com", "pass7", "Female", LocalDate.of(2003, 3, 6),
                "Receptionist"));
        staffs.add(new Staff("Frank", "Garcia", "frankgarcia@clinicstaff.com", "pass8", "Male",
                LocalDate.of(2001, 7, 4), "Receptionist"));
        staffs.add(new Staff("Grace", "Martinez", "gracemartinez@clinicstaff.com", "pass9", "Female",
                LocalDate.of(1999, 3, 3), "Administrator"));
        return staffs;
    }
