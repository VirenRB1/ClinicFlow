...
public class BookAppointmentModeHandler extends BaseSearchUserModeHandler {

    public BookAppointmentModeHandler(
            Activity activity,
            String userEmail,
    ...
    public void setup() {
        ...
        view.setSearchTitle(R.string.search_for_book);
        view.setActionText(R.string.book);
    }
