...
//
//// im not sure of what parameters we need for appointment yet so i made some
// assumptions based on common ones.
//
//
...
// // chat GPT asked for duration but i dont know if. we need that since we have
// start and end time
// // and those are gonna be estimates
// private AppointmentStatus status;
// private final String createdByUserId; // this could be created by paitent
// // or staff but i believe it shoudl be by the staff cuz the staff documents
// for the patient
//
...
// cannot be null");
// this.endDateTime = Objects.requireNonNull(endDateTime, "endDateTime cannot be
// null");
...
// public String getNotes() { return notes; } // idk if we need a setter for
// notes
...
// }
//
// public void rescheduleAppointment(LocalDateTime newAppointmentStart,
// LocalDateTime newAppointmentEnd) {
...
// }
//
// private static void validateTimeRange(LocalDateTime start, LocalDateTime
// end){
