...
//
//        this.patientVisibleSummary = patientVisibleSummary == null ? "" : patientVisibleSummary;// tenary operator
//        this.physicianNotes = physicianNotes == null ? "" : physicianNotes; //condition ? valueIfTrue : valueIfFalse
//
